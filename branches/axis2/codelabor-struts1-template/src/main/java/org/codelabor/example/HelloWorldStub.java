...
public class HelloWorldStub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		__operation.setName(new javax.xml.namespace.QName(
				"http://example.codelabor.org", "sayHello"));
	...
	public HelloWorldStub(
		...
		this(
				...
				"http://10.10.100.144:8088/codelabor-struts1-template/services/HelloWorld.HelloWorldHttpSoap12Endpoint/");
	...
	public HelloWorldStub() throws org.apache.axis2.AxisFault {
		...
		this(
				"http://localhost:8088/codelabor-struts1-template/services/HelloWorld.HelloWorldHttpSoap12Endpoint/");
	 ...
	 * 
	 * @see org.codelabor.example.HelloWorld#sayHello
	 * @param sayHello0
	 */

	public org.codelabor.example.HelloWorldStub.SayHelloResponse sayHello(

	org.codelabor.example.HelloWorldStub.SayHello sayHello0)
...

	{
		...
		try {
			...
			java.lang.Object object = fromOM(
					...
					org.codelabor.example.HelloWorldStub.SayHelloResponse.class,
					getEnvelopeNamespaces(_returnEnv));

			return (org.codelabor.example.HelloWorldStub.SayHelloResponse) object;
	 ...
	 * 
	 * @see org.codelabor.example.HelloWorld#startsayHello
	 * @param sayHello0
	 */
	...
	final org.codelabor.example.HelloWorldCallbackHandler callback)
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback() {
					public void onMessage(
						...
						try {
							...
							callback
									.receiveResultsayHello((org.codelabor.example.HelloWorldStub.SayHelloResponse) object);
							...
							if (faultElt != null) {
								if (faultExceptionNameMap.containsKey(faultElt
									...
									try {
										...
										callback
												.receiveErrorsayHello(new java.rmi.RemoteException(
														ex.getMessage(), ex));
									} catch (java.lang.ClassCastException e) {
	...
	public static class SayHelloResponse implements
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://example.codelabor.org", "sayHelloResponse", "ns1");

		private static java.lang.String generatePrefix(
				java.lang.String namespace) {
			if (namespace.equals("http://example.codelabor.org")) {
				return "ns1";
			}
		...
		public void serialize(
			...
			if (local_returnTracker) {
				namespace = "http://example.codelabor.org";
				if (!namespace.equals("")) {
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			if (local_returnTracker) {
				elementList.add(new javax.xml.namespace.QName(
						"http://example.codelabor.org", "return"));
	...
	public static class SayHello implements
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://example.codelabor.org", "sayHello", "ns1");
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			if (localNameTracker) {
				elementList.add(new javax.xml.namespace.QName(
						"http://example.codelabor.org", "name"));
	...
	private org.apache.axiom.om.OMElement toOM(
			org.codelabor.example.HelloWorldStub.SayHello param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param.getOMElement(
					org.codelabor.example.HelloWorldStub.SayHello.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			org.codelabor.example.HelloWorldStub.SayHelloResponse param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							org.codelabor.example.HelloWorldStub.SayHelloResponse.MY_QNAME,
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (org.codelabor.example.HelloWorldStub.SayHello.class
					.equals(type)) {

				return org.codelabor.example.HelloWorldStub.SayHello.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (org.codelabor.example.HelloWorldStub.SayHelloResponse.class
					.equals(type)) {

				return org.codelabor.example.HelloWorldStub.SayHelloResponse.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
