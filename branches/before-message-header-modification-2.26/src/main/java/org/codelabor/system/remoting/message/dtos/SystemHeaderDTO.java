...
public class SystemHeaderDTO {
	...
	private final static int EAI_RCV_PGM_ID_LENGTH = 40;
	private final static int MCI_SRV_NO_LENGTH = 3;
	...
	private final static int RSP_TR_CD_LENGTH = 11;
	private final static int MCI_SSSN_NO_LENGTH = 6;
	private final static int RESERVED1_LENGTH = 12;
	...
	public final static int LENGTH = STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH
			...
			+ EAI_LNKN_ID_LENGTH + EAI_RCV_PGM_ID_LENGTH + MCI_SRV_NO_LENGTH
			...
			+ XA_TR_DSCD_LENGTH + OG_TR_CD_LENGTH + RSP_TR_CD_LENGTH
			+ MCI_SSSN_NO_LENGTH + RESERVED1_LENGTH;
	...
	private String rspTrCd;
	private String mciSssnNo;
	private String reserved1;
	private final String charsetName = "EUC-KR";

	public String getMciSssnNo() {
		return mciSssnNo;
	}

	public void setMciSssnNo(String mciSssnNo) {
		this.mciSssnNo = mciSssnNo;
	}
	...
	public String getMciSrvNo() {
		return mciSrvNo;
	}

	public void setMciSrvNo(String mciSrvNo) {
		this.mciSrvNo = mciSrvNo;
	}
	...
	public String getRspTrCd() {
		return rspTrCd;
	}

	public void setRspTrCd(String rspTrCd) {
	...
	public byte[] toBytes() throws Exception {
		...
		IOUtil.bytecopy(this.getEaiRcvPgmId(), destBytes,
				...
				charsetName);
		IOUtil.bytecopy(this.getMciSrvNo(), destBytes, STND_TLG_THWH_LEN_LENGTH
				+ TLG_DSCD_LENGTH + ITN_INCD_LENGTH + TR_CD_LENGTH
				+ SCRN_NO_LENGTH + SYS_DSCD_LENGTH + TR_ID_CH_CODE_LENGTH
				+ TR_ID_PID_LENGTH + TR_ID_REQ_DT_LENGTH + TR_ID_REQ_TM_LENGTH
				+ TR_ID_SEQ_LENGTH + LNKG_SNO_LENGTH + OG_TR_ID_LENGTH
				...
				+ EAI_RCV_PGM_ID_LENGTH, MCI_SRV_NO_LENGTH, ' ', charsetName);
		IOUtil.bytecopy(this.getOsdRqsChnlCd(), destBytes,
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						...
						+ MCI_RQS_DT_LENGTH + MCI_RQS_DTL_TM_LENGTH
						+ EAI_LNKN_ID_LENGTH + EAI_RCV_PGM_ID_LENGTH
						+ MCI_SRV_NO_LENGTH, OSD_RQS_CHNL_CD_LENGTH, ' ',
				charsetName);
		IOUtil.bytecopy(this.getOsdIncd(), destBytes, STND_TLG_THWH_LEN_LENGTH
				...
				+ TMNL_TPCD_LENGTH + MCI_SRV_ID_LENGTH + MCI_RQS_DT_LENGTH
				+ MCI_RQS_DTL_TM_LENGTH + EAI_LNKN_ID_LENGTH
				+ EAI_RCV_PGM_ID_LENGTH + MCI_SRV_NO_LENGTH
				+ OSD_RQS_CHNL_CD_LENGTH, OSD_INCD_LENGTH, ' ', charsetName);
		...
		IOUtil.bytecopy(this.getOsdSrvNodNo(), destBytes,
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						...
						+ EAI_LNKN_ID_LENGTH + EAI_RCV_PGM_ID_LENGTH
						+ MCI_SRV_NO_LENGTH + OSD_RQS_CHNL_CD_LENGTH
						+ OSD_INCD_LENGTH + OSD_TLG_ID_LENGTH
						+ OSD_TR_ID_LENGTH, OSD_SRV_NOD_NO_LENGTH, ' ',
				charsetName);
		IOUtil.bytecopy(this.getTrRqsChnlCd(), destBytes,
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						...
						+ OSD_INCD_LENGTH + OSD_TLG_ID_LENGTH
						+ OSD_TR_ID_LENGTH + OSD_SRV_NOD_NO_LENGTH,
				TR_RQS_CHNL_CD_LENGTH, ' ', charsetName);
		IOUtil.bytecopy(this.getOgTrRqsChnlCd(), destBytes,
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						...
						+ OSD_INCD_LENGTH + OSD_TLG_ID_LENGTH
						+ OSD_TR_ID_LENGTH + OSD_SRV_NOD_NO_LENGTH
						+ TR_RQS_CHNL_CD_LENGTH, OG_TR_RQS_CHNL_CD_LENGTH, ' ',
				charsetName);
		IOUtil.bytecopy(this.getTrPrcsRslCd(), destBytes,
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						...
						+ OSD_TR_ID_LENGTH + OSD_SRV_NOD_NO_LENGTH
						+ TR_RQS_CHNL_CD_LENGTH + OG_TR_RQS_CHNL_CD_LENGTH,
				TR_PRCS_RSL_CD_LENGTH, ' ', charsetName);
		IOUtil.bytecopy(this.getXaTrDscd(), destBytes, STND_TLG_THWH_LEN_LENGTH
				...
				+ OSD_TR_ID_LENGTH + OSD_SRV_NOD_NO_LENGTH
				+ TR_RQS_CHNL_CD_LENGTH + OG_TR_RQS_CHNL_CD_LENGTH
				+ TR_PRCS_RSL_CD_LENGTH, XA_TR_DSCD_LENGTH, ' ', charsetName);
		IOUtil.bytecopy(this.getOgTrCd(), destBytes, STND_TLG_THWH_LEN_LENGTH
				...
				+ OSD_TR_ID_LENGTH + OSD_SRV_NOD_NO_LENGTH
				+ TR_RQS_CHNL_CD_LENGTH + OG_TR_RQS_CHNL_CD_LENGTH
				+ TR_PRCS_RSL_CD_LENGTH + XA_TR_DSCD_LENGTH, OG_TR_CD_LENGTH,
				' ', charsetName);
		IOUtil.bytecopy(this.getRspTrCd(), destBytes, STND_TLG_THWH_LEN_LENGTH
				+ TLG_DSCD_LENGTH + ITN_INCD_LENGTH + TR_CD_LENGTH
				+ SCRN_NO_LENGTH + SYS_DSCD_LENGTH + TR_ID_CH_CODE_LENGTH
				+ TR_ID_PID_LENGTH + TR_ID_REQ_DT_LENGTH + TR_ID_REQ_TM_LENGTH
				+ TR_ID_SEQ_LENGTH + LNKG_SNO_LENGTH + OG_TR_ID_LENGTH
				...
				+ TR_RQS_CHNL_CD_LENGTH + OG_TR_RQS_CHNL_CD_LENGTH
				+ TR_PRCS_RSL_CD_LENGTH + XA_TR_DSCD_LENGTH + OG_TR_CD_LENGTH,
				RSP_TR_CD_LENGTH, ' ', charsetName);
		IOUtil.bytecopy(this.getMciSssnNo(), destBytes,
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						+ TR_CD_LENGTH + SCRN_NO_LENGTH + SYS_DSCD_LENGTH
						+ TR_ID_CH_CODE_LENGTH + TR_ID_PID_LENGTH
						+ TR_ID_REQ_DT_LENGTH + TR_ID_REQ_TM_LENGTH
						...
						+ OSD_TR_ID_LENGTH + OSD_SRV_NOD_NO_LENGTH
						+ TR_RQS_CHNL_CD_LENGTH + OG_TR_RQS_CHNL_CD_LENGTH
						+ TR_PRCS_RSL_CD_LENGTH + XA_TR_DSCD_LENGTH
						+ OG_TR_CD_LENGTH + RSP_TR_CD_LENGTH,
				MCI_SSSN_NO_LENGTH, ' ', charsetName);
	...
	public void fromBytes(byte[] bytes) throws Exception {
		...
		setMciSrvNo(IOUtil.substr(
				...
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						...
						+ MCI_RQS_DT_LENGTH + MCI_RQS_DTL_TM_LENGTH
						+ EAI_LNKN_ID_LENGTH + EAI_RCV_PGM_ID_LENGTH
						+ MCI_SRV_NO_LENGTH, charsetName).trim());
		...
		setOsdIncd(IOUtil.substr(
				...
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						...
						+ EAI_LNKN_ID_LENGTH + EAI_RCV_PGM_ID_LENGTH
						+ MCI_SRV_NO_LENGTH + OSD_RQS_CHNL_CD_LENGTH
						+ OSD_INCD_LENGTH, charsetName).trim());
		...
		setOsdTrId(IOUtil.substr(
				...
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						...
						+ MCI_SRV_NO_LENGTH + OSD_RQS_CHNL_CD_LENGTH
						+ OSD_INCD_LENGTH + OSD_TLG_ID_LENGTH
						+ OSD_TR_ID_LENGTH, charsetName).trim());
		setOsdSrvNodNo(IOUtil
				.substr(
						bytes,
						STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH
		...
		setTrRqsChnlCd(IOUtil.substr(
				...
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						...
						+ OSD_INCD_LENGTH + OSD_TLG_ID_LENGTH
						+ OSD_TR_ID_LENGTH + OSD_SRV_NOD_NO_LENGTH
						+ TR_RQS_CHNL_CD_LENGTH, charsetName).trim());
		...
		setTrPrcsRslCd(Integer.parseInt(IOUtil.substr(
				...
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						...
						+ OSD_TR_ID_LENGTH + OSD_SRV_NOD_NO_LENGTH
						+ TR_RQS_CHNL_CD_LENGTH + OG_TR_RQS_CHNL_CD_LENGTH
						+ TR_PRCS_RSL_CD_LENGTH, charsetName).trim()));

		setXaTrDscd(IOUtil.substr(
				bytes,
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						+ TR_CD_LENGTH + SCRN_NO_LENGTH + SYS_DSCD_LENGTH
						+ TR_ID_CH_CODE_LENGTH + TR_ID_PID_LENGTH
		...
		setOgTrCd(IOUtil.substr(
				...
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						...
						+ TR_RQS_CHNL_CD_LENGTH + OG_TR_RQS_CHNL_CD_LENGTH
						+ TR_PRCS_RSL_CD_LENGTH + XA_TR_DSCD_LENGTH
						+ OG_TR_CD_LENGTH, charsetName).trim());
		setRspTrCd(IOUtil.substr(
				bytes,
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						+ TR_CD_LENGTH + SCRN_NO_LENGTH + SYS_DSCD_LENGTH
						+ TR_ID_CH_CODE_LENGTH + TR_ID_PID_LENGTH
				...
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						...
						+ TR_RQS_CHNL_CD_LENGTH + OG_TR_RQS_CHNL_CD_LENGTH
						+ TR_PRCS_RSL_CD_LENGTH + XA_TR_DSCD_LENGTH
						+ OG_TR_CD_LENGTH + RSP_TR_CD_LENGTH, charsetName)
				.trim());
		setMciSssnNo(IOUtil.substr(
				bytes,
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						+ TR_CD_LENGTH + SCRN_NO_LENGTH + SYS_DSCD_LENGTH
						+ TR_ID_CH_CODE_LENGTH + TR_ID_PID_LENGTH
				...
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						...
						+ TR_PRCS_RSL_CD_LENGTH + XA_TR_DSCD_LENGTH
						+ OG_TR_CD_LENGTH + RSP_TR_CD_LENGTH
						+ MCI_SSSN_NO_LENGTH, charsetName).trim());
		setReserved1(IOUtil.substr(
				...
				STND_TLG_THWH_LEN_LENGTH + TLG_DSCD_LENGTH + ITN_INCD_LENGTH
						...
						+ TR_PRCS_RSL_CD_LENGTH + XA_TR_DSCD_LENGTH
						+ OG_TR_CD_LENGTH + RSP_TR_CD_LENGTH
						+ MCI_SSSN_NO_LENGTH + RESERVED1_LENGTH, charsetName)
				.trim());
	}
	...
	public String toString() {
		...
		retValue.append("SystemHeaderDTO ( ").append(super.toString()).append(
				...
				.append(TAB).append("charsetName = ").append(this.charsetName)
				.append(TAB).append("eaiLnknId = ").append(this.eaiLnknId)
				.append(TAB).append("eaiRcvPgmId = ").append(this.eaiRcvPgmId)
				.append(TAB).append("inpTlgRcvgDt = ")
				...
				.append(TAB).append("mciSrvNo = ").append(this.mciSrvNo)
				.append(TAB).append("mciSssnNo = ").append(this.mciSssnNo)
				...
				.append(TAB).append("rspTpcd = ").append(this.rspTpcd).append(
						TAB).append("rspTrCd = ").append(this.rspTrCd).append(
